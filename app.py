...
class CourseSchema(ma.Schema):
    class Meta:
        fields = ("course_crn", "course_name", "course_description", "course_dept")
        model = Course
...
class ForumSchema(ma.Schema):
    class Meta:
        fields = ("id", "title", "description", "rating", "date")
        model = Forum
...
def reminders():
    ...
    reminder = Reminder.query.filter_by().all()
...
def addforum():
    ...
    forums = Forum(title, description, rating)
